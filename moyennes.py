...
#----------------------------------
def calcul_moyennes_matieres(notes):
    """
...
#----------------------------------
def calcul_moyennes_eleves(coeffs, notes):
    """
    entrée : dico des notes
...
if __name__ == '__main__':
    ...
    moyennes_matieres = calcul_moyennes_matieres(notes)
    print "moyennes_matieres", moyennes_matieres
    moyennes_eleves = calcul_moyennes_eleves(coeffs, notes)
